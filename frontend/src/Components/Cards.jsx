...
const Cards = () => {
    return (
        <div className=' my-4 '>
            <div className='container  px-3 py-3.5 flex flex-col gap-3 md:flex-row md:mx-auto md:justify-center md:gap-10 '>

                <div className='px-5 py-5 border border-gray-300 rounded-lg flex flex-col gap-2.5 justify-center shadow hover:shadow-sky-50 md:w-[500px]'>
