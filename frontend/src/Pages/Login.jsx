    ...
    return (
        <div className="h-screen flex justify-center items-center bg-gray-100 px-5">
            ...
            <div className="bg-white flex flex-col  gap-5 w-full max-w-md py-7 px-5 rounded-lg shadow">
                ...
                <form className="flex flex-col gap-5 py-7" onSubmit={handleSubmit}>
                    {
                    ...
                    <div className="flex flex-col gap-2 justify-center">
                        ...
                        <input type="email" placeholder="Enter your email" id="email" className="border border-gray-300 px-2 py-2 rounded-lg"
                            onChange={(e) => handleOnChange(e)} name="email" value={data.email} required />
                    </div>
                    <div className="flex flex-col gap-2 justify-center">
                    ...
                    <button type="submit" className="text-center text-white font-semibold bg-blue-500 py-2 mt-5 rounded-lg text-[16px] cursor-pointer hover:bg-blue-600 hover:text-gray-100 transition-all md:text-[18px]" >
